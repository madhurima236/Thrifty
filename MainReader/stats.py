...
if __name__ == '__main__':
    ...
    walmart_receipts.add_receipt("/Users/madhurima/PycharmProjects/ReceiptManagement/MainReader/WalmartReceipts/5c43798f9d036.image.jpg")
    receipt_stats = Statistics(walmart_receipts.categories_to_prices)
    receipt_stats.bar_graphs()
    walmart_receipts.add_receipt("/Users/madhurima/PycharmProjects/ReceiptManagement/MainReader/WalmartReceipts/9C5Q9Rt.jpg")
    receipt_stats = Statistics(walmart_receipts.categories_to_prices)
    receipt_stats.bar_graphs()
